...
var Commontext = `
{
        ...
        "markdown": {
                "title": "Yearning",
                "content": "## SQL工单通知 \n\n **工单编号:** $WORKID \n\n **数据源:** $SOURCE \n\n **工单说明:** $TEXT \n\n **提交人员:** <font color = \"#78beea\"><@$ID></font> \n\n **审核人员:** <font color = \"#78beea\"><@gebangfeng><@xiajianbo></font> \n\n **下一步操作人:** <font color=\"#fe8696\">$AUDITOR</font> \n\n **平台地址:** [$HOST]($HOST) \n\n  **状态:** <font color=\"#1abefa\">$STATE</font> \n\n"
        }
}
...
func dingMsgTplHandler(state string, generic interface{}) string {
	...
	if !stateHandler(state) {
        ...
        "gebangfeng":     "GeBangFeng",
        "xiajianbo":      "XiaJianBo",
        "anbo":           "f904f6cb60cc8f4ff8e4ce7b97ae0ea0",
        "zhangliqiang":   "dq",
        "lizhen":         "LiZhen",
        "huangjin":       "mr.h",
        "liuqingyan":     "1789",
        "liuwei":         "whynot",
        "wanglei":        "GuaHuZiShangYuanQi",
        "zhanghe":        "FaDaHe",
        "zhangwei":       "MuXiao",
        "zhengying":      "ZhengYing",
        "lilei":          "LiLei",
        "chenxi":         "chenxi",
        "zhangguixing":   "zhangguixing",
        }
        id, exists:= userList[order.Username]
        if !exists {
            id = order.Username
        }
	text := Commontext
	...
	text = strings.Replace(text, "$ID", id, -1)
	fmt.Println(text)
	return text
}
